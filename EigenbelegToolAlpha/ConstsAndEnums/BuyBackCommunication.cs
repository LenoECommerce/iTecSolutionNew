...
namespace EigenbelegToolAlpha.ConstsAndEnums
{
    public static class BuyBackCommunication
    {
        ...
        public static string nonFunctionalGradeErrorFoundMessage = "Schönen Guten Tag,\r\n\r\nwir würden gerne einmal nachfragen, " +
            "was für ein Problem Sie mit dem Gerät hatten? Das fragen wir in dem Zustand immer gerne nach, " +
            "damit unsere Techniker das Gerät wieder besser aufbereiten können.\r\n\r\n" +
